...
public class MapStorageTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Get R1: " + MAP_STORAGE.get(R1.getFullName()));
//      System.out.println("Get dummy: " + MAP_STORAGE.get("dummy"));
        ...
        MAP_STORAGE.delete(R1.getFullName());
        printAll();
        System.out.println("\nGet R2: " + MAP_STORAGE.get(R2.getFullName()));
        System.out.println("Update R2:");
        MAP_STORAGE.update(R2);
        System.out.println("Get R2: " + MAP_STORAGE.get(R2.getFullName()));
